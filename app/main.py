...
def process_task(queue: Queue, lock: Lock, continue_: Value):
    ...
    Task4_PutOnRing6(camera2_path, image_queue, sequence, 1)
    del Task4_PutOnRing6

    # # 执行任务六 从圆盘取第二轮物块
    from tasks.Task2GetFromPlate import Task2_GetFromPlate
    Task2_GetFromPlate(camera2_path, image_queue, sequence, 2)
    del Task2_GetFromPlate

    # 执行任务七 在粗加工区放取第二轮物块
    from tasks.Task3PutOnRing3 import Task3_PutOnRing3
    Task3_PutOnRing3(camera2_path, image_queue, sequence, 2)
    del Task3_PutOnRing3

    # 执行任务八 在暂存区码垛放置物块
    from tasks.Task4PutOnRing6 import Task4_PutOnRing6
    Task4_PutOnRing6(camera2_path, image_queue, sequence, 2)
    del Task4_PutOnRing6
